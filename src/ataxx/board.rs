...
pub enum PositionParseErr {
    JumpTooLong,        // A jump spec was too big for the current rank.
    InvalidColorIdent,  // Invalid character in Square spec.
    FileDataIncomplete, // Insufficient number of Square spec entries.
